    ...
    return (
      ...
      <div>
          <Breadcrumb>
            ...
            <BreadcrumbItem active onClick={() => this.props.history.push(`/inicio/administracion/planes-historicos/planes-cgr`)} >Gestión de Gacetas Oficiales
de la Contraloría General de la República</BreadcrumbItem>          
          </Breadcrumb>
        </div>
