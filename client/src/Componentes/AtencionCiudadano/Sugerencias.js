...
export default class Sugerencias extends Component {
  ...
  async enviarSugerencia(e){
    ...
    if(this.validarCampos()){
      ...
      const sugerencia_request = await fetch('/api/sugerencias/crear_sugerencia', request_options);
  ...
  validarCampos() {
    ...
    // Validación de la descripción de la sugerencia
  ...
  render() {
    ...
    let modal_operacion_fallida = 
      <Modal isOpen={this.state.modal_operacion_fallida} toggle={() => this.setState({modal_operacion_fallida: !this.state.modal_operacion_fallida})}>
        ...
        <ModalBody>
          <p>Ha ocurrido al enviar su sugerencia, por favor intente nuevamente más tarde. <br/> Si el problema persiste, póngase en contacto con un administrador a través de sicmb_dev@gmail.com</p>
        </ModalBody>
    ...
    let modal_operacion_exitosa = 
      <Modal isOpen={this.state.modal_operacion_exitosa} toggle={() => this.setState({modal_operacion_exitosa: !this.state.modal_operacion_exitosa})}>
        ...
        <ModalBody>
          <p>Su sugerencia se ha enviado exitosamente. Identificador de la sugerencia: <br/>
      ...
      <React.Fragment >
        ...
        <Row className="justify-content-center">
          <Col className="text-center">
            <h4>Llena el siguiente formulario para enviar una sugerencia</h4>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            <Form id="formulario-sugerencias" onSubmit={this.enviarSugerencia}>
              ...
              <FormGroup row>
                <Col xs={12} sm={12} md={12} lg={12}>
                  ...
                  <span id="campo-descripcion" className="error-usuarios">Descripción de la sugerencia inválida, este campo no puede estar vacío</span>
                </Col>
              </FormGroup>
