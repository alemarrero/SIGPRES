...
router.post('/crear_area', autorizarAdministrador, function(req, res, next) {
  models.areas
  .create({
...
router.post('/actualizar_area', autorizarAdministrador, function(req, res){
  models.areas.update({
    nombre: req.body.nombre,
...
router.post('/habilitar_area', autorizarAdministrador, function(req, res){
  models.areas.update({
    habilitado: true 
  }, {where: {id: req.body.id}})
  .then(x => {
...
router.post('/deshabilitar_area', autorizarAdministrador, function(req, res){
  models.areas.update({
    habilitado: false 
  }, {where: {id: req.body.id}})
  .then(x => {
